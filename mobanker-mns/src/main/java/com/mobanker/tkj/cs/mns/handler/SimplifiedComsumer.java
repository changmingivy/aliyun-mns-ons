...
public abstract class SimplifiedComsumer implements HttpRequestHandler {

    private static final Logger logger  = LoggerFactory.getLogger(SimplifiedComsumer.class);
